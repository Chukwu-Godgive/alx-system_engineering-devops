1) 0-current_working_directory - This script shows the command code used to print the absolute path name of the current working directory in your terminal.
